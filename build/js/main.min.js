...
/* harmony import */ var _modules_modals_showModal_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/modals/showModal.js */ "./js/modules/modals/showModal.js");
/* harmony import */ var _modules_form_form_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/form/form.js */ "./js/modules/form/form.js");
/* harmony import */ var _modules_about_company_about_company_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/about-company/about-company.js */ "./js/modules/about-company/about-company.js");
/* harmony import */ var _modules_about_company_about_company_js__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_modules_about_company_about_company_js__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var _modules_accordion_accordion_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/accordion/accordion.js */ "./js/modules/accordion/accordion.js");
/* harmony import */ var _modules_accordion_accordion_js__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_modules_accordion_accordion_js__WEBPACK_IMPORTED_MODULE_5__);
...
var aboutCompanySection = document.querySelector('.about-company');
var aboutCompanyButton = aboutCompanySection.querySelector('.about-company__button');
var aboutCompanyHiddenContent = aboutCompanySection.querySelector('.about-company__hidden-content');
...
var accordionDetails = document.querySelectorAll('details');
var accordionSummery = document.querySelectorAll('summary');

function handleClickOnDetails() {
  var detailsOpened = document.querySelectorAll('details[open]');

  var _iterator = _createForOfIteratorHelper(detailsOpened),
      _step;
...
/* harmony import */ var _modals_showModal_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../modals/showModal.js */ "./js/modules/modals/showModal.js");
...
var sendData = function sendData() {
  fetch('https://echo.htmlacademy.ru/', {
    ...
    if (response.ok) {
      Object(_modals_showModal_js__WEBPACK_IMPORTED_MODULE_0__["closeModal"])();
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _api_api_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../api/api.js */ "./js/modules/api/api.js");
...
telInputs.forEach(function (telInput) {
  Object(imask__WEBPACK_IMPORTED_MODULE_1__["default"])(telInput, maskOptions);
...
forms.forEach(function (form) {
  form.addEventListener('submit', function (evt) {
    evt.preventDefault();
    Object(_api_api_js__WEBPACK_IMPORTED_MODULE_0__["sendData"])();
    evt.target.reset();
  });
});
...
var openModalButton = document.querySelector('.main-nav__button');
var closeModalButton = document.querySelector('.modal__close-button');
var modal = document.querySelector('.modal');
var overlay = document.querySelector('.overlay');
var pageBody = document.querySelector('.page-body');

var onShowModalEscKeydown = function onShowModalEscKeydown(evt) {
  if (Object(_utils_js__WEBPACK_IMPORTED_MODULE_0__["isEscapeKey"])(evt)) {
    evt.preventDefault();
